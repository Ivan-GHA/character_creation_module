...
def attack(char_name: str, char_class: str) -> str:
    """Атаки персонажа для разных классов."""
...
def defence(char_name: str, char_class: str) -> str:
    """Защита персонажа для разных классов."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Специальные действия персонажа для разных классов."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    циклы тренировки в вечном цикле до отмены пользователем.
    """
    if char_class == 'warrior':
...
def main() -> None:
    """Корневая функция. Приветсвтует игрока и вызвает функции тренировки."""
